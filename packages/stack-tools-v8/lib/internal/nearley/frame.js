...
var grammar = {
    ...
    {"name": "Frame$subexpression$1", "symbols": ["Text", "_", {"literal":"("}, "_", {"literal":"eval"}, "__", {"literal":"at"}, "__", "CallSite", "_", "Frame$subexpression$1$ebnf$1", "_", {"literal":")"}], "postprocess": (d) => buildEvalFrame(d[0], get(d, 10, 2), d[8])},
    ...
    {"name": "Locator", "symbols": ["Text"], "postprocess": (d) => buildLocator(d[0])},
