...
var grammar = {
    ...
    {"name": "Frame$subexpression$1", "symbols": ["FunctionName", "_", {"literal":"("}, "_", {"literal":"eval"}, "__", {"literal":"at"}, "__", "CallSite", "_", "Frame$subexpression$1$ebnf$1", "_", {"literal":")"}], "postprocess": (d) => buildEvalFrame(d[0], get(d, 10, 2), d[8])},
    {"name": "Frame$subexpression$1", "symbols": ["CallSite"], "postprocess": (d) => buildFrame(d[0])},
    {"name": "Frame$subexpression$1", "symbols": [{"literal":"<"}, {"literal":"omitted"}, {"literal":">"}], "postprocess": (d) => ({ type: 'OmittedFrame' })},
    ...
    {"name": "CallSite", "symbols": ["Call", "__", {"literal":"("}, "_", {"literal":"index"}, "__", "Number", "_", {"literal":")"}], "postprocess": (d) => buildCallSite(d[0], { type: "IndexSite", index: d[6] })},
    {"name": "CallSite", "symbols": ["Site"], "postprocess": (d) => buildCallSite(undefined, d[0])},
    ...
    {"name": "Site", "symbols": ["Locator", "_", "Position"], "postprocess": (d) => ({ type: "FileSite", locator: d[0], position: d[2] })},
    {"name": "Site", "symbols": [{"literal":"<"}, {"literal":"anonymous"}, {"literal":">"}], "postprocess": () => ({ type: "AnonymousSite" })},
    {"name": "Site", "symbols": [{"literal":"native"}], "postprocess": () => ({ type: "NativeSite" })},
    {"name": "Position", "symbols": [{"literal":":"}, "_", "Number", "_", {"literal":":"}, "_", "Number"], "postprocess": (d) => ({ type: 'Position', line: d[2], column: d[6] })},
    {"name": "AsMethod", "symbols": [{"literal":"["}, {"literal":"as"}, "__", "FunctionName", {"literal":"]"}], "postprocess": (d) => d[3]},
    {"name": "Locator$ebnf$1", "symbols": []},
    {"name": "Locator$ebnf$1", "symbols": ["Locator$ebnf$1", "SpacePathFragment"], "postprocess": function arrpush(d) {return d[0].concat([d[1]]);}},
    {"name": "Locator", "symbols": ["PathFragment", "Locator$ebnf$1"], "postprocess": (d) => buildLocator(d[0] + stringFrom(d[1]))},
    {"name": "Locator", "symbols": [{"literal":"<"}, {"literal":"anonymous"}, {"literal":">"}], "postprocess": () => ({ type: "AnonymousLocator" })},
