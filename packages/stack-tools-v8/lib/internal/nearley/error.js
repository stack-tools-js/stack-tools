...
var grammar = {
    ...
    {"name": "ErrorStack", "symbols": ["CompleteError", "ErrorStack$ebnf$1"], "postprocess": (d) => buildErrorChain([d[0], ...d[1].map((d) => d[1])])},
    {"name": "ErrorStack", "symbols": ["Header"], "postprocess": (d) => buildErrorChain([buildError(d[0])])},
